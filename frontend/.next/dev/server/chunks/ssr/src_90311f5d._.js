module.exports = [
"[project]/src/infrastructure/http/publicClient.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const publicClient = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].create({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$http$2f$publicClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/http/publicClient.ts [app-ssr] (ecmascript)");
;
;
function useItemListByShopSWR(shopCode) {
    ...
    const fetcher = async ()=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$http$2f$publicClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["publicClient"].get(`/shops/${shopCode}/items`);
        return res.data;
    };
    const { data, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(key, fetcher, {
...
function useItemSearchByShopSWR(shopCode, query) {
    ...
    const fetcher = async ()=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$http$2f$publicClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["publicClient"].get(`/search/shop-items`, {
            params: {
                shop_code: shopCode,
                keyword: query
            }
...
//# sourceMappingURL=src_90311f5d._.js.map