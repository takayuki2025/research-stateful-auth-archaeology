...
final class BuildProvisionalItemEntitiesUseCase
{
    /**
     * analysisPayload: analysis_results.payload['analysis'] 相当
     * （AtlasAnalysisResult->toArray() の中身）
     */
    public function handle(int $itemId, array $analysisPayload): void
    {
