...
use App\Modules\Payment\Application\UseCase\Admin\TrustLedger\ListPayoutsUseCase;
use Illuminate\Http\Request;

final class ListPayoutsController extends Controller
{
    public function __construct(
        private ListPayoutsUseCase $useCase,
    ) {
    }
    ...
    public function __invoke(Request $request)
    {
        $data = $request->validate([
            ...
            'status' => 'sometimes|string|in:requested,processing,paid,failed,all',
